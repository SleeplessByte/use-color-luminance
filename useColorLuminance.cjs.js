...
exports.colorLuminance = exports.useColorLuminance = exports.useIsColorDark = void 0;
 ...
 *   useIsColorDark('#333')
 */
function useIsColorDark(color, perceived, threshold) {
    if (threshold === void 0) { threshold = DEFAULT_THRESHOLD; }
    return useColorLuminance(color, perceived) < threshold;
}
exports.useIsColorDark = useIsColorDark;
function useColorLuminance(color, perceived) {
    return react_1.useMemo(function () { return colorLuminance(color, perceived); }, [color, perceived]);
}
exports.useColorLuminance = useColorLuminance;
/**
 ...
 */
function colorLuminance(color, perceived) {
